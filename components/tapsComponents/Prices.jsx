        ...
        <div className="flex flex-col gap-3  ">
          ...
          <div className=" flex flex-col gap-5 md:flex-row md:py-4 md:gap-7 ">
            ...
            <div className="flex flex-col  gap-2 md:flex-1  ">
              <h4 className="text-[#17233e] text-xl font-Poppins capitalize ">MAY-SEPT</h4>
              <p  className="text-[#777] font-Poppins capitalize text-lg">
            ...
            {/* winter */}
            <div className="flex flex-col  gap-2 md:flex-1 ">
              <h4 className="text-[#17233e] text-xl font-Poppins capitalize ">OCT-APRIL</h4>
              <p  className="text-[#777] font-Poppins capitalize text-lg">
