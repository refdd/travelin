    ...
    style={{ backgroundImage: `url(${bg.src})` }}
     className='relative h-screen w-full bg-no-repeat bg-fixed bg-cover bg-top -z-10'>
        ...
        <div className='h-full w-full flex flex-col justify-center items-center z-10'>
            <h1 className='uppercase text-3xl md:text-5xl text-white font-bold font-serif '>{typeList} LIst</h1>
            <p className='text-white font-serif capitalize text-xl'><span className='text-[#029e9d]'>Home</span> | {typeList} list Leftside</p>
        </div>
        {/* layout */}
