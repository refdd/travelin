            ...
            >
              ...
              >
                ...
                <div className=" flex gap-3 flex-col md:flex-row items-center">
                  <p className="text-[16px] text-center md:text-left text-[#777] font-Poppins ">
                    {" "}
                    {item.duration} Days {item.type}{" "}
                  </p>
                  <h4 className="text-[16px] text-center md:text-left text-[#777] font-Poppins capitalize ">
                    {" "}
                    cities : {item.destinations}
                  </h4>
                </div>
                <p className="text-[#029e9d] text-center md:text-left text-[16px] font-Poppins ">
                  {" "}
                  {item.overview}
                </p>
              </div>
              ...
              <div
                className={
                  desplaygrid
                    ? "flex flex-col gap-2 justify-center items-center md:flex-row md:flex-wrap "
              ...
              >
                <div
                  className={
                    desplaygrid
                      ? "flex gap-2 w-full justify-center items-center md:justify-end md:w-[40%] "
                      : "flex gap-1 w-full justify-center items-center md:justify-end "
                  }
                >
                ...
                <p className="text-right text-lg text-[#777] font-Poppins ">
                  200 review
                </p>
                <div
                  className={
                    desplaygrid
                      ? "flex gap-3  md:flex-row"
                      : "flex gap-3  md:flex-col"
                  }
                >
                  <span className="text-[#777] font-Poppins text-lg md:text-right  ">
                    {" "}
                    Start from
                  </span>
                  <h4 className="text-right font-mono font-bold text-[24px] ">
                    {" "}
                    ${" "}
                    {item.start_price -
                      (item.start_price * item.discount) / 100}
                  </h4>
                </div>
                <p className="text-right text-sm font-Poppins capitalize  text-[#029e9d]">
                  Per Person
                </p>
                <Link href={`/egypt-tours/${item.slug}`}>
