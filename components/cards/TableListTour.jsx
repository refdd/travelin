...
//   }, [ ])
  ...
  return (
    <div ref={divfixrd} className="container mx-auto pt-9 ">
        ...
        <table className="w-full text-sm text-left ">
          <thead className="text-xs text-white  uppercase bg-[#029e9d]  ">
            <tr>
              <th
                scope="col"
                className="py-3 px-3 border-l border-gray-700  text-sm font-Poppins font-bold md:text-center md:text-lg    "
              >
                name tour
              </th>
              <th
              ...
              listTour.map((item) => (
                ...
                >
                  <Link href={`/egypt-tours/${item.slug}`}>
                    <th
                      scope="row"
                      className="py-4 px-2  cursor-pointer text-[#029e9d] text-sm font-Poppins font-bold md:text-center md:text-lg "
                    >
                      {item.title}
                    </th>
                  </Link>
