   ...
   <div className='flex flex-col gap-4 md:flex-row  md:gap-7 '>
        ...
        <div className='flex flex-col gap-3 md:flex-1'>
          <div className='flex gap-7'>
            ...
            <h1 className='text-center text-[#17233e] font-Poppins font-bold text-2xl capitalize md:text-left md:text-4xl md:leading-[1.5] lg:text-[55px] leading-none  md:px-3 lg:px-8 '>Apple Honors Eight Developers With Annual Apple Design Awards.</h1>
